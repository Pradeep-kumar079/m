...
const Event = require('../model/eventSchema'); // make sure this is the correct path
...
exports.getDashboard = async (req, res) => {
  try {
    ...
    const allevents = await Event.find(); // fetch all events

    res.render('admin/dashboard', {
      totalUsers,
      activeUsers,
      allevents // pass events to the EJS view
    });
  } catch (err) {
    console.error(err);
